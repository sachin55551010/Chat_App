...
export const LoginPage = () => {
  ...
  return (
    <div className="min-h-dvh pt-[var(--nav-h)] flex flex-col items-center p-1">
      <form
      ...
      >
        ...
        <p className="text-[.9rem]">To Start using app lets Login first</p>
        ...
        <p className="text-gray-500 text-[.9rem]">
          ...
          <NavLink to="/signup" className="font-semibold underline">
            Sign Up
          </NavLink>
        </p>
      </form>
